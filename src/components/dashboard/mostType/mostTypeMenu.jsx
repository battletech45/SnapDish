  ...
  return (
    <main className="flex flex-col gap-4">
        <section className="flex items-start justify-start gap-2">
            <div className=" rounded-full w-5 h-4 lg:h-5 bg-[#FF7CA3] mt-1" />
        ...
        <section className="flex items-start justify-start gap-2">
            <div className=" rounded-full w-5 h-4 lg:h-5 bg-[#FFB572] mt-1" />
            <div className="flex flex-col">
        ...
        <section className="flex items-start justify-start gap-2">
            <div className=" rounded-full w-5 h-4 lg:h-5 bg-[#65B0F6] mt-1" />
            <div className="flex flex-col">
